...
grep -Fqx 'VERSION_CAPABILITIES NATIVE_TRANSFER_RUNS_CONFIG_CAPABILITY or capCreateStats capBounceMsgBody or capReportVersion or capShortDequeue or 64 or 128 or config.version!' \
