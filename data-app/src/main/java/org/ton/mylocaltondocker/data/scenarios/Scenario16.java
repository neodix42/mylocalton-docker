...
public class Scenario16 implements Scenario {
  ...
  public void run() {
    ...
    adminWallet.send(adminWalletConfig);
    Utils.sleep(5, "deploying NFT item #1");
    ...
    adminWallet.send(adminWalletConfig);
    Utils.sleep(5, "deploying NFT item #2");
    ...
    adminWallet.send(adminWalletConfig);
    Utils.sleep(5, "deploying nft marketplace");
    ...
    Utils.sleep(5, "transferring item-1 to nft-sale-1 and waiting for seqno update");
    ...
    transferNftItem(
        ...
        "gift2".getBytes(),
        adminWallet.getAddress());
    Utils.sleep(5, "transferring item-2 to nft-sale-2 and waiting for seqno update");
